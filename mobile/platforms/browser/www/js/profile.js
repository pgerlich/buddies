...
angular.module("myApp").controller("mainCtrl", function($scope, $uibModal){
	...
	function showCustomerPortal(){
		...
		$scope.openVehicleModal = function (size) {
	...
	function showEmployeePortal(){
		//Adding direct deposit info
		//If direct deposit info is set, it's read only.
	}
...
angular.module('myApp').controller('vehicleModalSaveCtrl', function ($scope, $uibModalInstance) {
	...
	$scope.ok = function () {
		...
		var vehicle = {make: $scope.make, model: $scope.model, color: $scope.ccolor, license: $scope.license}
